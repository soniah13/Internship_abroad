    ...
    useEffect(() => {
        const fetchJob = async () => {
            try {
                ...
                if (data && data.id) {
                    setJob(data); // Assuming the first item in jobs is the relevant job
                } else {
            ...
            <div className="container mx-auto p-4 sm:p-6 md:p-8 text-base sm:text-lg">
                ...
                <div className="flex flex-col w-full max-w-7xl mx-auto items-center justify-center lg:flex-row gap-6">
                    ...
                    <div className="flex-1 bg-blue-100 p-4 sm:p-6 shadow-lg rounded-md">
                        ...
                        <button onClick={handleDelete} className='mt-4 px-4 py-2 bg-red-300 text-white font-semibold rounded hover:bg-red-600 transition'>
                            DELETE JOB
                        </button>
                    </div>
                </div>
