...
function Resume({onComplete}) {
  ...
  return (
    <div className='max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-lg '>
      ...
      Your passport plays a key role in getting an internship. 
      </p>

      <div className='text-center mb-8'>
         <a href='https://immigration.go.ke/application-requirements/'
      ...
      <h3 className='text-xl font-medium text-blue-600 mb-4 text-center'> Upload Your Passport </h3>
