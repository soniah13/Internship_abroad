  ...
  return (
    <div className='container mx-auto p-4 sm:p-6 md:p-8 text-base sm:text-lg'>
        <button onClick={() => navigate(-1)}
            ...
            <svg className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 20 20"> <path d="M10 5L3 12l7 7V5z" />
             </svg> Back
                </button>
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col w-full max-w-5xl mx-auto items-center justify-center lg:flex-row gap-6">
                        {/* Internship Details */}
                        <div className="flex-1 bg-blue-100 p-6 shadow-lg rounded-md">
                            {message && <p className='text-red-600'>{message}</p>}
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <h2 className='text-2xl font-medium mb-4'>Apply for Internship</h2>
